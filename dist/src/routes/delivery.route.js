...
router.post("/request", upload_middleware_1.upload.single("itemImage"), upload_middleware_1.validateFileType, delivery_controller_1.requestDelivery);
...
router.post("/:id/complete", delivery_controller_1.completeDelivery);
